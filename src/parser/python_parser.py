    ...
    def _extract_symbols_recursive(
        ...
        if node.type == "decorated_definition":
            ...
            if definition_node:
                self._extract_definition_with_decorators(
                    definition_node, source, file_meta, symbols, parent_class, decorators
                )
            return
        ...
        if node.type == "class_definition":
            ...
            if name_node:
                ...
                self._add_class_symbol(node, source, file_meta, symbols, class_name, decorators=[])
        ...
        # 함수 정의
            ...
            if name_node:
                ...
                self._add_function_symbol(
                    node, source, file_meta, symbols, full_name, kind, parent_class, decorators=[]
                )
