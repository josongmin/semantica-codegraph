...
class TypeHintAnalyzer:
    ...
    def __init__(self):
        ...
        self.current_function: str | None = None  # 현재 분석 중인 함수
    ...
    def _get_annotation_name(self, annotation: ast.AST) -> str | None:
        """
        타입 어노테이션에서 이름 추출
    ...
    def _analyze_getattr(self, node: ast.Call, function_name: str | None) -> list[InferredCall]:
        """
